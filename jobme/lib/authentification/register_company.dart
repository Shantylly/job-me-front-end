      ...
      if (isPhone == true) {
        try {
          var response = await http.post(
              Uri.parse('http://10.0.2.2:8080/company/register/phone'),
              body: ({
          ...
          if (response.statusCode == 200) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => const DashboardCompany()),
            );
          } else {
            print(response.body);
        ...
        try {
          var response = await http.post(
              Uri.parse('http://10.0.2.2:8080/company/register/email'),
              body: ({
